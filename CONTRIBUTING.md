...
It is an input to the [kujenga-blockchain](https://github.com/Kujenga-Network/kujenga-blockchain) repository which also includes a verifiable delay function implementation that it imports from the [kujengavdf repo](https://github.com/Kujenga-Network/kujengavdf) (in c/c++), and a proof of space implementation that it imports from the [kujengapos repo](https://github.com/Kujenga-Network/kujengapos). BLS signatures are imported from the [bls-signatures repo](https://github.com/Kujenga-Network/bls-signatures) as blspy. There is an additional dependency on the [kujengabip158 repo](https://github.com/Kujenga-Network/kujengabip158).

...
export const CreateRLAdminWallet = () => {
  ...
  function create() {
    ...
    if (
      kujengaper_input.value === '' ||
      Number(kujengaper_input.value) === 0 ||
      !Number(kujengaper_input.value) ||
      isNaN(Number(kujengaper_input.value))
    ) {
      dispatch(
        openDialog(
          <AlertDialog>

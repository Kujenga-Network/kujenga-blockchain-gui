...
import icon from '../../assets/img/kujenga_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Kujenga Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Kujenga-Network/kujenga-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>

...
import { CardHero, Flex, Link } from '@kujenga/core';
import { PlotHero as PlotHeroIcon } from '@kujenga/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Kujenga. '
              }
              <Link
                target="_blank"
                href="https://github.com/Kujenga-Network/kujenga-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
